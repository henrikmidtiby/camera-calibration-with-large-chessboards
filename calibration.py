...
def main():
    ...
    parser.add_argument('--min_coverage', metavar='', type=float, default=25, help='Minimum percentage coverage of the checkerboard in the image for image to be considered (default 25)')
